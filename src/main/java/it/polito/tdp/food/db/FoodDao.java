...
public class FoodDao {
	...
	//metodo che prende le porzioni che rispettano le calorie richieste
	public List<String> portionsCalorie(int calorie){
	...
	//metodo che mi restituisce le adiacenze del grafo
	public List<Adiacenti> getAdiacenti(){
		...
		try {
			...
			while(res.next()) {
				try {
					list.add(new Adiacenti(res.getString("p1.portion_display_name"), 
